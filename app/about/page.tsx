...
export default async function About() {
	...
	return (
		<main className={styles.container}>
			...
			<p>
				We're UC San Diego's student-led cybersecurity club, part of the ACM at UC San Diego student chapter. Through our workshops, competitions, and socials, we aim to make cybersecurity accessible and have tons of fun along the way.
			</p>
			<h2>Join Us</h2>
			<p>
			...
			<p>
				...
				quarter. If this seems too daunting, you can also apply to be a Diamond Staff in fall quarter. It's a lighter commitment where you can spend two quarters with us to see if we're right for each other.	Join the{" "}
